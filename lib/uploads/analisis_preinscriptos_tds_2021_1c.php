...
<html lang="es" class="bg-white">
  <head>
    ...
    <title>Análisis de PreInscriptxs TDS</title>
  ...
  <body>    
      ...
      <div class=".container-fluid">
        ...
        <div class="row mb-12">
          ...
          <div class="col-12">
            ...
            <h2 class="row justify-content-center">Análisis de preinscriptxs al curso TDS</h2>
            ...
            <div class="card-deck">
              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <p class="card-text">Antigüedad en el colectivo o en la organización</p>
    ...
    <script type="text/javascript" src="pages/analisis_preinscriptos_tds_2021_1c.js"></script>
