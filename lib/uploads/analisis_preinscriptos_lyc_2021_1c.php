...
<html lang="es" class="bg-white">
  <head>
    ...
    <title>Analisis de PreInscriptxs LYC</title>
  ...
  <body>    
      ...
      <div class=".container-fluid">
        ...
        <div class="row mb-12">
          ...
          <div class="col-12">
            ...
            <h2 class="row justify-content-center">Analisis de preinscriptxs al curso LYC</h2>
            ...
            <div class="card-deck mb-12">
              <div class="card mb-6">
                <div class="card-body">
                  ...
                  <div class="genero" id="generoConteo">Cantidad total del participantes postulados: </div>  
                </div>
              </div>
              <div class="card mb-6">
                <div class="card-body">
    ...
    <script type="text/javascript" src="pages/analisis_preinscriptos_lyc_2021_1c.js"></script>
