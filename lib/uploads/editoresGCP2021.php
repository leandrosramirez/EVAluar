...
//Solapas del legajo 
$xcrud->fields('id,submitdate,lastpage,startlanguage,token,startdate,datestamp,ipaddr,refurl,db1,db2,db3,db3a1,db312,db315,db314,db313,db316,db9,db9other,db10,db11,db12,db13,db14,db15,db16,db22,db23,db23a1,db7,C24,C25,C25other,C251,C26,C27,C28,C29,C291,c30,c30other,c31,c32,c33,c34,C35,C36,C37,PA1,PA2,PA3,PA4,conexion30,conexion31,conexion32SQ001,conexion32SQ002,conexion32SQ003,conexion33SQ001,conexion33SQ002,conexion33SQ003,conexion33SQ004,conexion34,conexion35,conexion36,DI1,DI2,DI3,DI4,DI5,DI6,DI7,P1,P1other,P2,P3,P4,P5,CO2,co3,co3filecount,CO1,PROVINCIA,DEPARTAMENTO,LOCALIDAD,id_provincia,id_region', false, 'Perfil del postulante');
