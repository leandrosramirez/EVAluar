...
$xcrud->table('gcp2021');
$xcrud->language('es');
$xcrud->table_name('PreInscriptos <a class="btn btn-primary btn-sm" href="https://datossociales.com/evaluar/lib/uploads/Guia_para_equipo_evaluador_de_postulaciones_para_GCP_2021.pdf" target="_blank" ><i class="fa fa-file"></i>  Guia de Evaluación</a>');
