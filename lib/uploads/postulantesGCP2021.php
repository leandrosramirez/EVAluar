...
$xcrud->columns('db1,db2,PROVINCIA,LOCALIDAD');
...
$xcrud->where("c35 = 'Me postulé pero no obtuve una vacante' OR ( co3filecount = 1 AND c33='No' ) "); 
// Me postulé pero no obtuve una vacante = Ya participo de GCP pero no curso / ( 1 = Subio carta aval Y  c33=No - No curso GCP)
