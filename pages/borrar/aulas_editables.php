...
$xcrud->label('fecha_finalizacionn','Fecha de finalización');
$xcrud->label('link_proyecto','Link al proyecto en Kanboard');
...
$xcrud->columns('id,nombre,direccion_min_cultura,Estudiantes,Gestores,Profesores,Profesores SPE,Invitades,fecha_inicio,link_proyecto');

//*********************************campos en el formulario******************
$xcrud->fields('id,nombre,link_curso,link_editar,nombre_corto,secretaria_min_cultura,direccion_min_cultura,fecha_inicio,link_proyecto');
...
<!-- menu -->
 ...
 <a type="button" class="btn btn-primary" href="https://datossociales.com/participantes/users/aulas_editables.php">Aulas Editables</a> 
