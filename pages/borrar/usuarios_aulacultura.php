...
$xcrud->language('es');
$xcrud->table_name('Usuarios AULA CULTURA');

$xcrud->label('id','identificador');
$xcrud->label('username','Nombre de Usuario');
$xcrud->label('email','Correo Electrónico');
$xcrud->label('firstname','Nombre');
$xcrud->label('lastname','Apellido');
$xcrud->label('idnumber','número de identificador');
$xcrud->label('institution','Institución');
$xcrud->label('department','Departamento');
$xcrud->label('phone1','Teléfono');
$xcrud->label('phone2','Celular');
$xcrud->label('city','Ciudad');
$xcrud->label('url','URL');
$xcrud->label('icq','icq');
$xcrud->label('skype','skype');
$xcrud->label('aim','aim');
$xcrud->label('yahoo','yahoo');
$xcrud->label('msn','msn');
$xcrud->label('country','País');
$xcrud->label('profile_field_DNI','DNI');
$xcrud->label('profile_field_Institucion','Institución');
$xcrud->label('profile_field_Provincia','Provincia');
...
$xcrud->columns('id,firstname,lastname,profile_field_Provincia');
